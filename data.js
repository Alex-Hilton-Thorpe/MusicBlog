...
const albums = [
    ...
    },
    {
        ...
        image: "thriller.jpg",
        review: "The skinniest Jackson, Bubbles dad, the King of Pop, the man who won 8 Grammies in one night, the gloved one, MJ. This man wasn’t just a music king; he was an icon who has transcended time. I remember in 2009 when I was in Grade R and people talking about his death, this man was so big that he had 6-year-olds discussing if he had been poisoned by his doctor. We have forgotten just how big he was, you would never see MJ at a sports event; we see artists today going to enjoy the Knicks beat the Cavs, he couldn’t. He is widely considered, and I find it hard to argue, the most culturally significant figure of the 20th century. I mean he still has 110 million monthly listeners, that is just ridiculous. MJ is from Indiana where he got started in his career with his family band called the Jackson 5; releasing hits such as “I want you back”. Then moving onto a solo career in the late 70s. Then in 1982 he released the album I listened to today; “Thriller” and is widely considered his best. He picked up 8 grammies for this album; album of the year, producer of the year etc. etc. This album produces what you would expect, massive song after massive song. There is a 3-song run in the middle consisting of Thriller, Beat it and then Billie Jean, could be the biggest 3 song run of all time. I think this albums’ production was simply phenomenal from top to bottom, I want to single out Billie Jean though, I have never truly listened to it until today and it really does live up to the hype beyond just being a popular song. When I decided on putting an MJ album in here, I was expecting just a generic pop album, but I really think that he made the generic sound. He was pushing boundaries at the time and truly deserves the crown. I really did enjoy this album and obviously the songs are easy to sing along too but it goes beyond just that, the album is a whirlpool of shifting emotions, from paranoia to romantic tension and social consciousness. I also particularly loved “The Girl Is Mine” as it has the only feature on the album, Paul McCartney (The best Beatle), and I feel you can look at this as a passing of a torch moment in a way. Anyway this looks like a whole lot of glazing, but I think I need to pay respect where deserved. I used to think MJ was overrated but after listening to him today I have a newfound respect.",
        songs: "1. The Girl Is Mine\n 2. Billie Jean\n 3. Beat It",
        rating: "9/10"
    },
    {
        day: 28,
